...
var appStyle = function appStyle(theme) {
  ...
  return {
    ...
    mainPanel: _objectSpread((_objectSpread2 = {}, _defineProperty(_objectSpread2, theme.breakpoints.up("md"), {
      width: "calc(100% - ".concat(_materialDashboardReact.drawerWidth, "px)")
    }), _defineProperty(_objectSpread2, "overflow", "auto"), _defineProperty(_objectSpread2, "position", "relative"), _defineProperty(_objectSpread2, "float", "right"), _objectSpread2), _materialDashboardReact.transition, {
      maxHeight: "100%",
      width: "100%",
